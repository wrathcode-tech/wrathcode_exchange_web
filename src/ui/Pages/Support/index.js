    ...
    return (
        <>
                ...
                <div className="dashboard_right">
                    <div className="upload-formate mb-6 d-flex justify-content-start align-items-center text-start">
                        <div>
                            <h3 className="mb-1">
                                Help/Support
                            </h3>
                            <p className=" mb-1 formate mb-0">
                                Raise ticket here...
                            </p>
                        </div>
                    </div>
                    <div className={`tt_main support_form_s ${isShow === 1 && "d-none"}`}>
                                            ...
                                            <tbody>
                                                {issueList?.length > 0 ? issueList.map((item, index) =>
                                                    <tr key={index} className={` ${(item?.seen === 0 && item?.status === 'Open') ? " font-weight-bold issue_text" : "issue_text"}`} >
                                                        ...
                                                        <td > <button type="button" className="btn btn-xs  btn-success " onClick={() => handleHidettMain(item)}  ><span>View</span></button></td>
                                                    </tr>
                                                ) : <tr rowSpan="5">
                                                    <td colSpan="12">
