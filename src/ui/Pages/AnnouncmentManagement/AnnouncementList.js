            ...
            <section class="announcement_section single_announcement">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <ul class="nav nav-tabs announcement_tabs" id="announcementTabs" >
                            {categoryList?.map((item, index) => {
                                ...
                                return (
                                    <li class="nav-item" role="presentation">
                                        <button class={`nav-link ${item?.title === readableTitle ? "active" : ""}`} id={item?.id} onClick={() => handleAnnounceList(formattedTitle, item?._id)}>
                                            {item?.title}
                                        </button>
                                    </li>
                                )
                            ...
                            {/* <li class="nav-item" >
                                <button class="nav-link active" id="crypto-tab" >
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="api-tab" d>
                    ...
                    <div class="tab-content announcement_content" id="announcementTabsContent">

                        <div class="tab-pane fade show active" id="crypto" role="tabpanel" aria-labelledby="crypto-tab">
                            <h3 class="text-white">{readableTitle}</h3>
                            ...
                            <nav class="pagination">
                                <ul class="justify-content-center">
                                    <li class="page-item disabled"><a class="page-link" href="#" tabIndex="-1" ariaDisabled="true">
                                    </a>
                                    </li>
                        ...
                        <div class="tab-pane fade" id="activities" role="tabpanel" aria-labelledby="activities-tab">
                            <h3 class="text-white">Latest Activities</h3>
                        ...
                        <div class="tab-pane fade" id="fiat" role="tabpanel" aria-labelledby="fiat-tab">
                            <h3 class="text-white">New Fiat Listings</h3>
                        ...
                        <div class="tab-pane fade" id="api" role="tabpanel" aria-labelledby="api-tab">
                            <h3 class="text-white">API Updates</h3>
